        ...
        <nav className="hidden md:flex items-center gap-8">
          {navItems.map((item) => (
            <motion.a
              ...
              className={`text-sm ${item.label === 'Poetry' ? 'text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold' : 'text-gray-400'} hover:text-white transition-colors`}
          ...
          <div className="px-4 py-4 space-y-3">
            {navItems.map((item) => (
              <a
                ...
                target={item.external ? '_blank' : '_self'}
                rel={item.external ? 'noopener noreferrer' : ''}
                className={`block text-sm ${item.label === 'Poetry' ? 'text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold' : 'text-gray-400'} hover:text-white transition-colors py-2`}
